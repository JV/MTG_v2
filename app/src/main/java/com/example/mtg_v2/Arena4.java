...
public class Arena4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_arena4);
    ...
    private void rollDice() {
        ...
        while (haveWinner != true) {
            ...
            } else  if (player4Roll > player1Roll && player4Roll > player2Roll && player4Roll > player3Roll
                    && player4Roll != player1Roll && player4Roll != player2Roll && player4Roll != player3Roll) {
                player4Name = etPlayer4.getText().toString();
                haveWinner = true;
                Toast.makeText(this, player4Name + " plays first", Toast.LENGTH_SHORT).show();
            }
        }
    }
